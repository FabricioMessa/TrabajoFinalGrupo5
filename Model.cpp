...
void Sesion::IniciarSesion()
{
	...
	do {
		...
		std::cout << "Ingrese su Contrasenha: " << std::endl;
		...
		else
		{
			...
			std::cout << "--------Usuario o Contrasenha INCORRECTA-------" << std::endl;
...
void Sesion::CrearUsuario()
{
	...
	do {
		...
		else
		{
			...
			std::cout << "--------Usuario o Contrase�a INCORRECTA-------" << std::endl;
			std::cout << "----------Vuelva a ingresar sus datos---------" << std::endl;
			Sleep(1000);
			system("cls");
...
SistemaContable::SistemaContable() 
{
	...
	std::ifstream archivo("BaseUsuarios.csv", ios::binary | ios::out | ios::app);
